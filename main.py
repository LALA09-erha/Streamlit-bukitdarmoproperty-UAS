...
# pige title
st.set_page_config(
    page_title="Prediksi Produksi Beer",
...
if home==False and about==False or home==True and about==False:
    st.markdown("<h1 style='text-align: center; color: white; margin:0 ; padding:0;'>Prediksi Produksi Beer</h1>", unsafe_allow_html=True)
    # setting kolom
...
if about==True and home==False:
    ...
    st.write(' Sesuai dengan nama datasetnya, data yang akan diprediksi berdasarkan bulan. Dataset ini memiliki 2 kolom yaitu Month dan Production. Kolom Month berisi bulan yang akan diprediksi dan kolom Production berisi jumlah produksi beer pada bulan tersebut, sehingga pengumpulan data dilakukan setiap bulan.')
